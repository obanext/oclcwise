...
const rows = [
  ...
  { field: "Combinatiefilters", inputType: "verwerkingslogica", status: "JA", oclcParameter: "facetFilter / termFilter", valuePattern: "WISE: verschillende filters = AND; hetzelfde facet = | (OR)", source: "actuele formulierwaarden", purpose: "Legt vast hoe meerdere zoekcriteria tot één OCLC-request worden gecombineerd.", example: "facetFilter=mediumTypeCode:BOE&facetFilter=languageCode:DUT|ENG", note: "Dit formulier gebruikt lokale WISE-velden. /api/oclc-search groepeert WISE-waarden van hetzelfde facet met |; verschillende facetFilter- en termFilter-criteria blijven afzonderlijke queryparameters. NBC+ gebruikt eigen nbc:-sleutels met herhaalde facetFilter-parameters (EN), zonder |-samenvoeging. Bij bronwisselen worden oude filters gewist; broncounters volgen diezelfde opdracht. De zoekpagina toont selecties afzonderlijk verwijderbaar en documenteert de conventies en werkelijke calls in de CSV." },
